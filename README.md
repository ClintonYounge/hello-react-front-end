...
**[Hello React Front End]** Is the front end part of a hello project that uses react to fetch and render the data received from a rails <a href="https://github.com/ClintonYounge/hello-rails-back-end">backend app.</a>
...
<details>
  ...
  <ul>
    <li><a href="https://github.com/ClintonYounge/hello-rails-back-end">Link to the ruby on rails backend of the project</a></li>
  </ul>
</details>
...
- Redux store
- Fetch method to grap data from the front end API.
- Component to render front end data.
...
```sh
  ...
  git clone https://github.com/ClintonYounge/hello-react-front-end.git
